...
namespace SignalRApi.Hubs
{
    public class SignalRHub:Hub
    {
		...
		public SignalRHub(ICategoryService categoryService, IProductService productService, IOrderService orderService, IMoneyCaseService moneyCaseService, IDiningTableService diningTableService, IBookingService bookingService, INotificationService notificationService)
		{
        ...
        public async Task SendStatistic()
        {
            ...
            var value15 = _orderService.TTodaysEarning();
            await Clients.All.SendAsync("ReceiveTodaysEarning", value15.ToString("0.00") + "₺");

            var value16 = _diningTableService.TDiningTableCount();
        ...
        public async Task SendProgress()
        {
            ...
            var value3 = _diningTableService.TDiningTableCount();
            ...
            var value9 = _productService.TProductCount();
            await Clients.All.SendAsync("ReceiveProductCount", value9);
        ...
        public async Task GetDiningTableStatus()
        {
            var value = _diningTableService.TGetListAll();
            await Clients.All.SendAsync("ReceiveDiningTableStatus", value);
        }
